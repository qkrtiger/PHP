...
이 PHP 코드는 `str_replace` 함수의 다양한 사용 예제를 보여줍니다. 각 예제는 주석으로 설명되어 있어 GitHub에서 쉽게 이해할 수 있습니다. 예제에는 다음과 같은 내용이 포함되어 있습니다:

1. 기본 사용법
2. 대소문자 구분 없이 치환 (`str_ireplace` 사용)
3. 여러 문자열 동시 치환
4. 치환 횟수 카운트
5. 문자열 배열에서 치환

이 코드를 GitHub에 올리면 다른 개발자들이 `str_replace` 함수의 다양한 활용 방법을 쉽게 이해하고 참조할 수 있을 것입니다. 필요하다면 README 파일을 추가하여 각 예제에 대한 추가 설명을 제공할 수도 있습니다.
